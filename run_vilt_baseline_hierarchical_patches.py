...
from lpmdataset.models.baselines.vilt_b32_finetuned_vqa_modified_hierarchical_patches import predict
...
def process_presentation(p: data_models.Presentation) -> None:
    ...
    out_dir = os.path.join("results", "vilt_b32_finetuned_vqa_modified_hierarchical_patches", root_folder, order_folder, video_folder)
