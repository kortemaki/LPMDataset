...
from lpmdataset.models.baselines.layoutlmv3_base_finetuned_rvlcdip_modified_hierarchical_patches import predict
...
def process_presentation(p: data_models.Presentation) -> None:
    ...
    out_dir = os.path.join("results", "layoutlmv3_base_finetuned_rvlcdip_modified_hierarchical_patches", root_folder, order_folder, video_folder)
